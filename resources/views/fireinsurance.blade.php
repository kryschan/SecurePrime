...
<body>
    ...
    <!-- Hero Start -->
    <div class="container-fluid bg-primary p-5 hero-header5 mb-5">
        <div class="row py-5">
            <div class="col-12 text-center">
                <h1 class="display-1 text-white animated zoomIn">Fire Insurance</h1>
            </div>
        </div>
    </div>
    <!-- Hero End -->
    ...
    <div class="col-lg-4 col-md-6 wow zoomIn box" data-wow-delay="0.3s">
        <div class=" bg-light border-bottom border-5 border-primary rounded">
            <div class="position-relative p-5 just row gx-5">
                ...
                <div class="col-lg-7">
                <div>
                    <h3 class="mb-3 mission just">FIRE INSURANCE</h3>
